    ...
    const workEx: IWorkExperience[] = [
        {
            ...
            tech: [
                ...
                'Node',
                'MySQL',
                {label: 'Redis', variant: PillVariant.Secondary},
                {label: 'Nuxt', variant: PillVariant.Secondary},
                {label: 'Strapi', variant: PillVariant.Secondary},
                {label: 'Rollup', variant: PillVariant.Secondary},
                {label: 'Devops', variant: PillVariant.Secondary},
                {label: 'Bitbucket pipeline', variant: PillVariant.Secondary},
            ],
            showKnowMore: true
        },
        {
            ...
            tech: [
                ...
                'AMP',
                {label: 'Rollup', variant: PillVariant.Secondary},
                {label: 'Gitlab CI/CD', variant: PillVariant.Secondary},
            ],
            showKnowMore: true
        },
        {
            ...
            tech: [
                ...
                'ASP.NET',
                'MSSQL',
                { label: 'SSRS', variant: PillVariant.Secondary },
                { label: 'Tortoise SVN', variant: PillVariant.Secondary },
            ],
            showKnowMore: true
        }
    ];
